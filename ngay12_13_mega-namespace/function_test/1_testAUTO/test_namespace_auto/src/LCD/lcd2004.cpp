    ...
    namespace lcd
    {
        ...
        void menuSelect(){
            ...
            {  
                ...
                OCR3A = 0;
                OCR3B = 0;
                main::manual::outSpeedBanhA = 0;
                main::manual::outSpeedBanhB = 0;
                if (xoaHienThi1 == 0)
                {
                    main::lcd::lcd.clear();
                    xoaHienThi1 = 1;
        ...
        void che_do_da_chon(){
            ...
            if (value_chooseMenu == 0 && chooseStatus == 0)
            {
                if(chooseChanged == true){
                    ...
                    lcd.clear();
                    main::PWM::PWM_16Bit_Frequency(main::manual::pinDkBanhA, 65);
                    main::PWM::PWM_16Bit_Frequency(main::manual::pinDkBanhB, 65);
                    xoaHienThi1 = 0;
                }
                // hành động 1: AUTO
